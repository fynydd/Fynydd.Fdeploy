...
public static class Identify
{
    ...
    public static string AppMajorVersion(Assembly assembly)
    {
        ...
        {
            AnsiConsole.MarkupLine($"AppMajorVersion Exception: {e.Message}");
        }
    ...
    public static string AppMinorVersion(Assembly assembly)
    {
        ...
        {
            AnsiConsole.MarkupLine($"AppMinorVersion Exception: {e.Message}");
        }
    ...
    public static string AppBuildVersion(Assembly assembly)
    {
        ...
        {
            AnsiConsole.MarkupLine($"AppBuildVersion Exception: {e.Message}");
        }
    ...
    public static string AppRevisionVersion(Assembly assembly)
    {
        ...
        {
            AnsiConsole.MarkupLine($"AppRevisionVersion Exception: {e.Message}");
        }
    ...
    public static string Version(Assembly assembly)
    {
        ...
        {
            AnsiConsole.MarkupLine($"Version Exception: {e.Message}");
        }
